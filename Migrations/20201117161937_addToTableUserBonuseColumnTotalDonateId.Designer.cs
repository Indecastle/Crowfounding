...
namespace Crowfounding.Migrations
{
    ...
    [Migration("20201117161937_addToTableUserBonuseColumnTotalDonateId")]
    partial class addToTableUserBonuseColumnTotalDonateId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crowfounding.Models.UserBonuse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BonuseId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Crowfounding.Models.UserBonuse", b =>
                {
                    b.HasOne("Crowfounding.Models.Bonuse", "Bonuse")
                        .WithMany("UserBonuses")
                        .HasForeignKey("BonuseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Crowfounding.Models.Finance.TotalDonate", "TotalDonate")
                        .WithMany("UserBonuses")
                        .HasForeignKey("TotalDonateId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
